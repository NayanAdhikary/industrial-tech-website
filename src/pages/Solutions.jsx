    ...
    <div style={{ position: 'relative' }}>
      ...
      <section className="reveal" style={{ height: '819px', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden', borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
        <div className="container grid md:grid-cols-2 gap-12 items-center relative z-10" style={{ width: '100%' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '4px 12px', backgroundColor: 'var(--color-primary-alpha-10)', border: '1px solid var(--color-primary-alpha-20)', borderRadius: '9999px', alignSelf: 'flex-start' }}>
          ...
          <div style={{ position: 'relative', height: '500px', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div className="glass-card" style={{ position: 'absolute', bottom: '16px', right: '16px', padding: '16px', borderRadius: '8px', zIndex: 20 }}>
              ...
              <div style={{ width: '128px', height: '4px', backgroundColor: 'var(--color-border-muted)', borderRadius: '9999px', overflow: 'hidden' }}>
      ...
      <section className="py-section-padding container reveal">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-8 glass-card relative" style={{ overflow: 'hidden', padding: '32px' }}>
            ...
            <div className="relative z-10 h-full flex flex-col">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4" style={{ marginTop: 'auto' }}>
                <div style={{ backgroundColor: 'var(--color-border-muted)', padding: '16px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          {/* Technical Specs */}
          <div className="md:col-span-4 glass-card relative flex flex-col" style={{ padding: '32px', background: 'linear-gradient(to bottom right, var(--color-primary-alpha-5), transparent)' }}>
            ...
            <ul style={{ display: 'flex', flexDirection: 'column', gap: '24px', flexGrow: 1, padding: 0, margin: 0, listStyle: 'none' }}>
              <li style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                <div style={{ width: '32px', height: '32px', borderRadius: '8px', backgroundColor: 'var(--color-primary-alpha-10)', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid var(--color-primary-alpha-30)', marginTop: '4px' }}>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div style={{ padding: '24px', borderRadius: '8px', backgroundColor: 'var(--color-surface-container)', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', gap: '24px', alignItems: 'center' }}>
                  <div className="font-label-mono-sm" style={{ fontSize: '32px', color: 'var(--color-primary-alpha-40)', fontWeight: 900 }}>01</div>
                  <div>
            ...
            <div className="relative">
              <div style={{ position: 'absolute', inset: 0, backgroundColor: 'var(--color-primary-alpha-20)', filter: 'blur(100px)', borderRadius: '50%' }}></div>
              <div className="glass-card" style={{ padding: 0, overflow: 'hidden' }}>
                <div style={{ backgroundColor: 'var(--color-surface-container-high)', padding: '12px 24px', borderBottom: '1px solid rgba(255,255,255,0.1)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div className="flex gap-2">
                    ...
                    <div style={{ width: '12px', height: '12px', borderRadius: '50%', backgroundColor: 'var(--color-primary-alpha-40)' }}></div>
                  </div>
