      ...
      <div className="relative z-10">
        ...
        <main className="py-24 px-margin-edge max-w-container-max mx-auto space-y-gutter">
          ...
          <section className="reveal" style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(4, 1fr)', gap: '24px', height: isMobile ? 'auto' : '500px' }}>
            ...
            <div 
              className="glass-panel p-8 bg-primary/5 border-primary/20"
              style={{ gridColumn: isMobile ? 'span 1' : 'span 2' }}
            >
              <div className="flex justify-between items-start">
                <div>
                  <h4 className="font-headline-lg-mobile text-white mb-2" style={{ margin: 0, fontSize: '20px' }}>Global Registry</h4>
                  <p className="font-label-xs text-on-surface-variant" style={{ marginTop: '8px' }}>Centralized node for all industrial identifiers.</p>
                </div>
            ...
            <div 
              ...
              style={{ gridColumn: isMobile ? 'span 1' : 'span 1' }}
            >
              <div style={{ fontFamily: 'var(--font-display)', color: 'var(--color-primary)', fontWeight: 'bold', fontSize: '28px', marginBottom: '4px' }}>2.4M</div>
              <div className="font-label-xs text-on-surface-variant uppercase" style={{ fontSize: '10px' }}>Mapped Objects</div>
            </div>
            ...
            <div 
              ...
              style={{ gridColumn: isMobile ? 'span 1' : 'span 1' }}
            >
              <div style={{ fontFamily: 'var(--font-display)', color: 'var(--color-primary)', fontWeight: 'bold', fontSize: '28px', marginBottom: '4px' }}>12ms</div>
              <div className="font-label-xs text-on-surface-variant uppercase" style={{ fontSize: '10px' }}>Latency Avg</div>
            </div>
          </section>
        </main>
